 ...
 *
 * @param Z Position
 * @desc Z位置(controls if it appears over/under map objects)
 * @default 5
 *
 * @param Auto Hide
 * @desc true or false. If true, 事件运行时图标将消失
 * @default true
 *
 * @param Icon Opacity
 * @desc 0-255. 图标的不透明度
 ...
 * ----------------------------------------------------------------------------
 *
 *   AIVISIBLE FALSE        // 禁用动作指示器
 *   AIVISIBLE TRUE         // 启用动作指示器
 *   
 */
